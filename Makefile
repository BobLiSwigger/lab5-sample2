...
test: 
	./bin/main tests/test.c > result/test.txt
	./bin/main tests/0.c > result/0.txt
	./bin/main tests/1.c > result/1.txt
	./bin/main tests/2.c > result/2.txt
	./bin/main tests/3.c > result/3.txt
	./bin/main tests/myTest.c > result/myTest.txt